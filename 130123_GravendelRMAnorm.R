...
plot(sur.fit, main='Gravendeel glioma data set',ylab='Survival probability',xlab='survival(months)', col=c('red','blue'),xlim=c(0,750))
legend('topright', c('CREB score > 50th, n=102', 'Stem cell score < 50th, n=94'), col=c('red', 'blue'),lwd=1, cex=0.6)
summary(data.surv)
