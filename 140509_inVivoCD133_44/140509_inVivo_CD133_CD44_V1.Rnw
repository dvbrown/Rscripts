...
All 4 permutations of the CSC cells sorted by FACS were compared by RNA-seq. Differential gene expression testing, exon usage and clustering were performed to resolve which transcriptional signature the CSC markers define \emph{in vivo} and were related to the tumour core and margin signature.\\
...
\addcontentsline{toc}{section}{\hspace*{-\tocsep}Results} % Adds this section to the table of contents with negative horizontal space equal to the indent for the numbered sections
  ...
  \subsection*{Validation of the orthotopic model}
    ...
    \paragraph {Flow cytometry comparisons of CD133 and CD44} a\\
...
%------------------------------------------------------------------------------------------------------------------------
  ...
  \subsection *{Comparing the transcriptome of the tumour margin and tumour core}
...
% Change this plot when you change the data source  
    ...
    \caption{{The suite of genes that are differentially expressed between core and margin} }
...
%------------------------------------------------------------------------------------------------------------------------
  ...
  \subsection*{Comparison of the transcrioptome of the CD133 and CD44 cells}  
    \paragraph {Do I separate the margin and core for FACS?}
\blindtext
...
%------------------------------------------------------------------------------------------------------------------------
  ...
  \subsection*{Gene signature and survival analysis}  
    \paragraph {Use the TCGA data to examine how relevant the signatures I have discovered are}
\blindtext
