...
\PaperTitle{Invasive margins and tumour core of GBM have different transcriptonal profiles and expression of cancer stem cell markers} % Article title

\Authors{Brown, Daniel V\textsuperscript{1}*, Ng, Wayne\textsuperscript{2}, Amiridis, Stephanie\textsuperscript{2}, 
Nicole Kountouri\textsuperscript{2}, Daniel, Paul M\textsuperscript{1}, Filiz, Gulay\textsuperscript{1}, Hollande, Fred\textsuperscript{3}, Drummond, Kate\textsuperscript{2},
...
\affiliation{\textsuperscript{3}\textit{Molecular Mechanisms of Tumour Progression, Department of Pathology, Australia}}
...
\Keywords{Cancer Stem Cells --- Glioblastoma --- Invasion --- Xenograft} % Keywords - if you don't want any simply remove all the text between the curly brackets
...
An orthotopic model of GIC driven GBM was used to examine the transcriptome of cells at the core of the tumour and the tumour margins.
The xenograft derived cells were also sorted by flow cytometry (FACS) for the putative stem cell markers CD133 and CD44.\\

All 4 permutations of the CSC cells sorted by FACS were compared by RNA-seq. Differential gene expression testing, exon usage and clustering were performed to resolve which genetic signature the CSC markers define \emph{in vivo}.\\

My hypothesis is that the tumour margins will express CD44, the hypoxic core will express CD133 and neither will be a marker of stemness. CD44 will mark migration/ invasion and CD133 will mark proliferating/ transit amplifying cells. Potentially the double positive cells will be cancer stem cells\\

This paper reveals novel insights into the tumour margin vs core transcriptome and the difference between CD44 and CD133 cells \emph{in vivo}. If I can get some primary tumour slides and stain them for CD133 and CD44 it will push the article into the next echelon of journals.
}
...
\begin{figure}[ht]
   \centering 
% Change this plot when you change the data source   
    \includegraphics[page=1, width=.95\linewidth]{/Users/d.brown6/Documents/Cell_biology/proliferation/Resazurin/140417_6clones/analysis/plots/140430_cd133CollatedSummary.pdf}
...
% Change this plot when you change the data source  
    ...
    \includegraphics[page=1, width=.65\linewidth]{/Users/d.brown6/Documents/RNAdata/danBatch1/bowtieGem/revHTSeq/GLMedgeR/graphs/131023_volcano.pdf}
    
    \caption{{The transcriptome of in vitro and in vivo signatures are very different} }
    \label{fig:inVivo}
\end{figure}

    \paragraph{I will only compare CD133 ositive GSCs. I will save the CD44 comparison to anopther short paper}
