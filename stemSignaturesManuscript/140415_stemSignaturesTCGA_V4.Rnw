...
{\emph I should actually present a table of these "core" CD133 coexpressed genes either in the main body or the suplemental of the paper.
...
The core coexpression module of CD133 and CD44 was used to build a data driven network.
