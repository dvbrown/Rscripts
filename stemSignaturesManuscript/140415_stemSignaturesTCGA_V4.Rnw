...
The most critical parameter was the cutoff used to build the model of coexpressed genes. \textbf {write some more stuffs here}.

WRITE UP THE SUBSAMPLING analysis
