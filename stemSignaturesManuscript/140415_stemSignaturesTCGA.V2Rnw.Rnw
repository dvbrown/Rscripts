...
<<cd133_dendogram, echo=FALSE, fig.cap='Dendogram of cd133 similar genes', fig.show='asis', cache=TRUE>>=
...
%------------------------------------------------------------------------------------------------------------------------
  ...
  \subsection*{Clinical relenvence of CD133 coexpressed genes}  
...
\begin{figure}[ht]
   \centering 
% Change this plot when you change the data source   
    \includegraphics[page=1, width=.45\textwidth]{/Users/d.brown6/Documents/stemCellSig/130117_signature/130123_collatedFigure.pdf}
