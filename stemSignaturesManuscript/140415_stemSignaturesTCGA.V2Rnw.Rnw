...
<<cd133_histogram, echo=FALSE, fig.cap='Distribution of cd133 correlated genes', fig.pos='H'>>=
...
qqline(result[,1])
@
Raising the power to 6 for the weighted network results in no genes being pushed to the right.
