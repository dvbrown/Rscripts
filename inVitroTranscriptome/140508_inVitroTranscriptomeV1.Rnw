...
\PaperTitle{Functional and genome wide examination of the cancer stem cell marker CD133 \emph{and CD44?} in Glioblastoma Multiforme stem cells} % Article title
