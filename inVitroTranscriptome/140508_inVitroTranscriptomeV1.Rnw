...
\JournalInfo{Stem Cells (IF = 7.7)\\ Stem Cell Research  (4.76)\\ 
European Journal of Cancer (5.0)\\ 
...
\PaperTitle{Functional and genome wide examination of the cancer stem cell marker CD133 in Glioblastoma Multiforme stem cells} % Article title
