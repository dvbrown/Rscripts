...
for(input in samplelist){
  ...
  plot(c(1:length(data)),data, pch=19,cex=0.3,col="black",type="p", ylim=c(min-0.5,max+0.5), xlab = "Chromosomes", ylab = "Copy number ", main=substr(titl, 1, 20) ,xaxt = "n",cex.lab=1.2)
