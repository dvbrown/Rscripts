...
root <- "/Users/u0107775/Data/GandT_Seq/160606_ValidationGandT/LogR/"
...
setwd(writedir)
samplelist <- list.files(path="~/Data/GandT_Seq/160606_ValidationGandT/LogR/", pattern = ".txt")

item = "SEGMENTSlogR.GCcorrected-M30-GC032370_AAGAGGCA-AGGCTTAG.cov.txt.M30.hits-vs-NoREF.M30.hits.window-500000.63bases_mappable.minw-4.GCcorrected-M30-II.cnv-PCF-kmin_3-gamma_25-fastPCF-window-500000vs-NoREF-M30-II75bases_mappable.txt"
